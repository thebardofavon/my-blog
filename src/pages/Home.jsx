...
//     const fetchPosts = async () => {
//       try {
//         const postsCollection = collection(db, 'posts'); // Access Firestore collection
//         const postsSnapshot = await getDocs(postsCollection); // Fetch posts
//         const postsList = postsSnapshot.docs.map(doc => ({
//           id: doc.id, // Document ID
//           ...doc.data() // Post data
//         }));
//         setPosts(postsList); // Set posts to state
//       } catch (error) {
//         console.error('Error fetching posts:', error);
//       } finally {
//         setLoading(false); // Set loading to false once the posts are fetched
//       }
//     };
